...
function Movie(props) {
  ...
  function handleClickMovie(name) {
    props.handleClickAddMovieParent(name);
  ...
  return (
    ...
    <CardBody>
        <p>Like <FontAwesomeIcon style={colorLike} icon={faHeart} onClick={() => handleClickMovie(props.movieName)} /></p>
